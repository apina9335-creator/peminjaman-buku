...
<head>
    ...
    <title>@yield('title', 'BookNook')</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; transition: background-color 0.3s, color 0.3s, border-color 0.3s; }
        body { font-family: 'Instrument Sans', sans-serif; background: var(--bg-body); color: var(--text-main); display: flex; min-height: 100vh; overflow-x: hidden; }
        ...
        .sidebar-menu-icon { width: 1.5rem; text-align: center; font-size: 1.3rem; }

        /* === 4. MAIN CONTENT WRAPPER === */
        .main-content { flex: 1; margin-left: 280px; display: flex; flex-direction: column; min-height: 100vh; max-width: calc(100vw - 280px); }
        ...
        .page-header h1 { font-size: 2.5rem; margin-bottom: 0.5rem; font-weight: 800; line-height: 1.2; }
...
<body>
    ...
    <div class="main-content">
        <nav>
            <div class="container">
                <div style="font-weight: 700; color: var(--text-main); font-size: 1.5rem;">Pengaturan Akun</div>
                <div class="user-menu">
