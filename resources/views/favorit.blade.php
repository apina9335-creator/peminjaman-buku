...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; transition: background-color 0.3s, color 0.3s, border-color 0.3s; }
        ...
        .btn-fav-remove { width: 100%; padding: 0.75rem; border: 1px solid var(--danger); border-radius: 0.75rem; color: var(--danger); font-weight: 600; cursor: pointer; transition: all 0.2s; font-size: 0.9rem; text-align: center; display: block; margin-top: 10px; background: transparent; }
        .btn-fav-remove:hover { background: rgba(239, 68, 68, 0.1); }
    </style>
</head>
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="/favorit" class="active"><span class="sidebar-menu-icon">❤️</span><span>Favorit</span></a></li>
    ...
    <div class="main-content">
        <nav>
            <div class="nav-container">
                <div class="nav-left"><h2>Buku Favorit</h2></div>
                <div class="user-menu">
        ...
        <div class="container">
            <div class="page-header">
                <h1>Daftar Keinginan ❤️</h1>
                <p>Simpan buku-buku yang ingin Anda baca di sini.</p>
            </div>
                    ...
                    <div class="book-card">
                        ...
                        <div class="book-info">
                            ...
                            <form action="{{ route('favorites.toggle') }}" method="POST">
                                ...
                                <button type="submit" class="btn-fav-remove">Hapus dari Favorit 💔</button>
                            </form>
                        </div>
                    </div>
                    @endforeach
            ...
            @else
                <div style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 1rem; padding: 3rem; text-align: center; box-shadow: 0 4px 6px var(--shadow);">
                    ...
                    <h3 style="color: var(--text-main); margin-bottom: 0.5rem;">Belum ada buku favorit</h3>
                    <p style="color: var(--text-muted); margin-bottom: 1.5rem;">Klik tombol hati (❤️) pada buku di Koleksi untuk menyimpannya di sini.</p>
                    <a href="{{ route('books.collection') }}" style="background: var(--primary); color: white; padding: 0.75rem 1.5rem; border-radius: 0.5rem; text-decoration: none; font-weight: 600;">Cari Buku Menarik</a>
                </div>
            @endif
        </div>
    </div>
